        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IconName = table.Column<string>(type: "TEXT", maxLength: 40, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LearningOutcomes = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    ...
                    ThumbnailPath = table.Column<string>(type: "TEXT", maxLength: 260, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Courses_DurationMinutes", "DurationMinutes > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileContentType = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Quizzes_PassMarkPercent", "PassMarkPercent BETWEEN 0 AND 100");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ResourceCompletions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ResourceCompletions_LearningResources_LearningResourceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuizAnswers_AnswerOptions_SelectedOptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_IsPublished_CategoryId",
                table: "Courses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResourceCompletions_LearningResourceId",
                table: "ResourceCompletions",
                column: "LearningResourceId");

            migrationBuilder.CreateIndex(
                name: "IX_ResourceCompletions_UserId_LearningResourceId",
                table: "ResourceCompletions",
