...
/// <summary>
/// Bound from the <c>Seed</c> section. Passwords must come from environment variables (or user-secrets); in Development
/// missing demo passwords are generated by <c>DevelopmentSeedPasswords</c> and never committed.
/// </summary>
public sealed class SeedOptions
{
    ...
    public string DemoStudentEmail { get; set; } = "student@learnhub.local";
