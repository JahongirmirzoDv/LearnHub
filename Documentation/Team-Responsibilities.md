...
| Deployment to Azure and GitHub Pages | R | – | – | S |
...
- `.github/workflows/ci.yml`, `deploy.yml`, `pages.yml`, `ef-migrations.yml`, `infra/provision.sh`, `scripts/`
- Documentation: `Architecture.md`, `Security-Review.md`, `Deployment.md`, `Proposal.md`
...
- Documentation: `Use-Cases.md`, `Navigation.md`
...
- Documentation: `Testing.md`, `Wireframes.md`, `Final-Report-Content.md`, `Viva-Questions.md`,
  `Team-Responsibilities.md`, `Git-Workflow.md`, `Requirements-Audit.md`, `README.md`
...
| Branches and pull requests | One short-lived branch per task; pull request with a description and screenshots for UI changes; at least one reviewer; merge only when CI is green (see [Git-Workflow.md](Git-Workflow.md)) |
